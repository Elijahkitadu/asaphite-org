...
import {
  Droplets, BookOpen, HeartPulse, Building2, ArrowRight
} from 'lucide-react'
      ...
      <div className="container-site relative">
        <div className="flex flex-col items-center gap-12">
          ...
          <SectionTitle
            ...
            subtitle="Every project we undertake falls within one of these focus areas — each one chosen because storytelling can unlock real, measurable change."
              ...
              return (
                ...
                >
                  <Link
                    href={area.href}
                    className={cn(
                      'group flex flex-col gap-5 p-6 rounded-2xl border h-full',
                  ...
                  >
                    ...
                    <div className="flex items-center justify-between pt-3
                      ...
                      <ArrowRight
                        size={16}
                        className="text-gray-300 group-hover:text-gold-400
