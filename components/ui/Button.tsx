...
type Variant = 'primary' | 'outline' | 'outline-gold' | 'ghost' | 'danger'
...
const variantStyles: Record<Variant, string> = {
  primary: `
    bg-gradient-to-r from-gold-400 to-yellow-400 text-navy-800
    shadow-[0_4px_24px_rgba(212,160,23,0.35)]
    hover:shadow-[0_8px_32px_rgba(212,160,23,0.5)]
    hover:-translate-y-0.5 active:translate-y-0
    font-semibold
  `,
  outline: `
    border-2 border-white/40 text-white backdrop-blur-sm
    hover:border-white/80 hover:bg-white/10
    hover:-translate-y-0.5 active:translate-y-0
  `,
  'outline-gold': `
    border-2 border-gold-400 text-gold-400
    hover:bg-gold-400 hover:text-navy-800
    hover:-translate-y-0.5 active:translate-y-0
  `,
  ghost: `
