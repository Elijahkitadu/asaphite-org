      ...
      <div className="min-h-screen bg-background flex items-center justify-center pt-24 pb-20">
        <div className="container-narrow text-center flex flex-col items-center gap-8">
          ...
          <div className="flex flex-col gap-3">
            <p className="text-xs font-semibold uppercase tracking-widest font-heading text-gold-400">Article in Progress</p>
            <h1 className="font-heading font-bold text-navy-800 text-3xl sm:text-4xl leading-tight">{title}</h1>
            <p className="text-gray-500 text-lg leading-relaxed max-w-lg">This article is being written. We publish when it is ready — not before. Check back soon.</p>
          </div>
          ...
          <div className="flex flex-wrap items-center justify-center gap-4 pt-2">
            <Button href="/blog" variant="outline-gold" size="md" icon={<ArrowLeft size={16} />}>Back to Blog</Button>
